...
I ran some small tests in [ChameleonRT](https://github.com/Twinklebear/ChameleonRT) rendering the Sponza scene
from [Morgan McGuire's Computer Graphics Archive](https://casual-effects.com/data/)
on an RTX 2070, rendering at 1280x720. To measure the performance of each method I tracked both the
...
and re-use the primary hit group (which implements an any hit shader to test against
